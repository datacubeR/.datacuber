...
yay -S google-chrome wezterm picom visual-studio-code-bin

echo "Installing from Pacman..."

sudo pacman -S ttf-firacode-nerd blueman gnome-keyring flameshot zsh zoxide eza fzf bat thefuck spotify zoom
